...
class Form1 extends JFrame {
	...
	Form1() {
		...
		JPanel panel0 = new JPanel(); // ќбща€ панель
		JPanel panel1 = new JPanel(); // это обща€ панель кнопок

		JPanel panelNubmers1 = new JPanel(); // ƒл€ кнопок действий
	...
	private void setButtonActions(ArrayList<JButton> buttonList, JLabel label) {
		...
		// действи€ дл€ кнопок арифметичесих действий
		for (int i = 10; i < 14; i++) {
			JButton b = buttonList.get(i);
			b.addActionListener(new ActionListener() {
				@Override
